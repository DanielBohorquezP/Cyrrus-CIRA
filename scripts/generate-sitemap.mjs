...
function contentSourceFor(esPath) {
  ...
  const blogSlug = esPath.match(/^\/perspectivas\/([a-z0-9-]+)$/)?.[1];
  if (blogSlug) return { ns: "blog", pick: [`posts.${blogSlug}`] };
  return null;
}
...
<!--
  ...
  blog-data.ts. Do not hand-edit URLs/structure here — edit route-meta.json or
  the data files instead and re-run \`node scripts/generate-sitemap.mjs\`.

...
export function SiteHeader() {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "fixed inset-x-0 top-20 z-20 max-h-[calc(100vh-5rem)] overflow-y-auto border-b border-border bg-background shadow-lg transition-[opacity,transform] duration-150 ease-out lg:hidden",
          mobileOpen

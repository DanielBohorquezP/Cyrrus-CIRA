...
const DEFAULT_MARKERS = [
  { lat: 23.63, lng: -102.55, label: "México" },
  { lat: 14.6, lng: -90.5, label: "Centroamérica" },
  { lat: 8.98, lng: -79.52, label: "Panamá" },
  { lat: 4.71, lng: -74.07, label: "Colombia" },
  { lat: -1.83, lng: -78.18, label: "Ecuador" },
  { lat: -9.19, lng: -75.02, label: "Perú" },
  { lat: -14.24, lng: -51.93, label: "Brasil" },
  { lat: -35.68, lng: -71.54, label: "Chile" },
  { lat: -38.42, lng: -63.62, label: "Argentina" },
  { lat: 39.83, lng: -98.58, label: "Estados Unidos" },
  { lat: 18.74, lng: -70.16, label: "Caribe" },
];

const DEFAULT_CONNECTIONS: { from: [number, number]; to: [number, number] }[] =
  [
    { from: [39.83, -98.58], to: [23.63, -102.55] },
    { from: [23.63, -102.55], to: [14.6, -90.5] },
    { from: [14.6, -90.5], to: [8.98, -79.52] },
    { from: [8.98, -79.52], to: [4.71, -74.07] },
    { from: [4.71, -74.07], to: [-1.83, -78.18] },
    { from: [4.71, -74.07], to: [18.74, -70.16] },
    { from: [-1.83, -78.18], to: [-9.19, -75.02] },
    { from: [-9.19, -75.02], to: [-35.68, -71.54] },
    { from: [-35.68, -71.54], to: [-38.42, -63.62] },
    { from: [-9.19, -75.02], to: [-14.24, -51.93] },
    { from: [-38.42, -63.62], to: [-14.24, -51.93] },
  ];

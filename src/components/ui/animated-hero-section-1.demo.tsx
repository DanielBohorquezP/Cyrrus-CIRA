...
export default function AnimatedHeroDemo() {
  ...
  return (
    <AnimatedHero
      backgroundImageUrl="https://images.unsplash.com/photo-1508739773434-c26b3d09e071?w=900&auto=format&fit=crop&q=60"
      logo={
        <>
          <MountainIcon className="h-6 w-6 text-white" />
          <span className="font-semibold text-white">TwentyFirst</span>
        </>
      }
      navLinks={navLinks}
      topRightAction={
